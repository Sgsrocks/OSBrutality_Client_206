...
public class RSInterface {
	...
	public static void unpack(StreamLoader streamLoader,
		...
		if(rsInterface.type == 4) {
				rsInterface.message = stream.readString().replaceAll("RuneScape", "OSBrutality");
	...
	public static void hiscores(TextDrawingArea[] wid) {
		...
		addText(42002, "OSBrutality Hiscores", wid, 2, 0xff981f, true);
	...
	public static void preloadEquipmentWidget(TextDrawingArea[] tda) {
		...
		addText(32003, "OSBrutality Preloaded Gear Setup", tda, 2, 0xFF981F);
	...
	public static void questTab(TextDrawingArea[] TDA) {
		...
		addText(29155, "OSBrutality", 0xFF981F, false, true, 52, TDA, 2);
		...
		addText(29161, "Player", 16750623, false, true, 52, TDA, 2);
		addHoverText(29162, "", "View Progress", TDA, 0, 16711680, false, true, 150);
		addHoverText(29163, "@or1@", "View Progress", TDA, 0, 0xffb000, false, true, 150);
		addHoverText(29164, "", "View Progress", TDA, 0, 16711680, false, true, 150);
		addHoverText(29165, "", "View Progress", TDA, 2, 16750623, false, true, 150);
		addHoverText(29569, "", "View Progress", TDA, 0, 16711680, false, true, 150);
		addHoverText(663, "", "View Progress", TDA, 0, 16711680, false, true, 150);
		...
		setBounds(29569, 8, 74, 5, Interface);
