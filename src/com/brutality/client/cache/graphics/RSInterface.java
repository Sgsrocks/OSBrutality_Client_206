...
public class RSInterface {
	...
	public static void unpack(StreamLoader streamLoader,
		...
		if(rsInterface.type == 4) {
				rsInterface.message = stream.readString().replaceAll("RuneScape", "OS-Brutality");
	...
	public static void hiscores(TextDrawingArea[] wid) {
		...
		addText(42002, "OS-Brutality Hiscores", wid, 2, 0xff981f, true);
		addConfigButton(42004, 42000, 298, 294, "Interfaces/Hiscores/KILLS", 69, 20, "Kills", 1, 5, 265);
		...
		addText(42013, "", wid, 1, 0xff981f, false);
		addText(42014, "", wid, 1, 0xff981f, false);
		addText(42015, "", wid, 1, 0xff981f, false);
		addText(42016, "", wid, 1, 0xff981f, false);
		addText(42017, "", wid, 1, 0xff981f, false);
		addText(42018, "", wid, 1, 0xff981f, false);
		addText(42019, "", wid, 1, 0xff981f, false);
		addText(42020, "", wid, 1, 0xff981f, false);
		addText(42021, "", wid, 1, 0xff981f, false);
		addText(42022, "", wid, 1, 0xff981f, false);
		addText(42023, "", wid, 0, 0xff981f, true);
		addText(42024, "", wid, 0, 0xff981f, true);
		addText(42025, "", wid, 0, 0xff981f, true);
		addText(42026, "", wid, 0, 0xff981f, true);
		addText(42027, "", wid, 0, 0xff981f, true);
		addText(42028, "", wid, 0, 0xff981f, true);
		addText(42029, "", wid, 0, 0xff981f, true);
		addText(42030, "", wid, 0, 0xff981f, true);
		addText(42031, "", wid, 0, 0xff981f, true);
		addText(42032, "", wid, 0, 0xff981f, true);
		addText(42033, "", wid, 0, 0xff981f, true);
		addText(42034, "", wid, 0, 0xff981f, true);
		addText(42035, "", wid, 0, 0xff981f, true);
		addText(42036, "", wid, 0, 0xff981f, true);
		addText(42037, "", wid, 0, 0xff981f, true);
		addText(42038, "", wid, 0, 0xff981f, true);
		addText(42039, "", wid, 0, 0xff981f, true);
		addText(42040, "", wid, 0, 0xff981f, true);
		addText(42041, "", wid, 0, 0xff981f, true);
		addText(42042, "", wid, 0, 0xff981f, true);
		addText(42043, "", wid, 0, 0xff981f, true);
		addText(42044, "", wid, 0, 0xff981f, true);
		addText(42045, "", wid, 0, 0xff981f, true);
		addText(42046, "", wid, 0, 0xff981f, true);
		addText(42047, "", wid, 0, 0xff981f, true);
		addText(42048, "", wid, 0, 0xff981f, true);
		addText(42049, "", wid, 0, 0xff981f, true);
		addText(42050, "", wid, 0, 0xff981f, true);
		addText(42051, "", wid, 0, 0xff981f, true);
		addText(42052, "", wid, 0, 0xff981f, true);
		addText(42053, "", wid, 0, 0xff981f, true);
		addText(42054, "", wid, 0, 0xff981f, true);
		addText(42055, "", wid, 0, 0xff981f, true);
		addText(42056, "", wid, 0, 0xff981f, true);
		addText(42057, "", wid, 0, 0xff981f, true);
		addText(42058, "", wid, 0, 0xff981f, true);
		addText(42059, "", wid, 0, 0xff981f, true);
		addText(42060, "", wid, 0, 0xff981f, true);
		addText(42061, "", wid, 0, 0xff981f, true);
		...
		rsinterface.child(2, 42004, 164, 63);
		rsinterface.child(3, 42005, 242, 63);
		rsinterface.child(4, 42006, 322, 63);
		rsinterface.child(5, 42007, 390, 63);
		rsinterface.child(6, 42008, 89, 66);
		rsinterface.child(7, 42009, 202, 66);
		rsinterface.child(8, 42010, 281, 66);
		rsinterface.child(9, 42011, 355, 66);
		rsinterface.child(10, 42012, 440, 66);
		rsinterface.child(11, 42013, 25, 89);
		rsinterface.child(12, 42014, 25, 109);
		rsinterface.child(13, 42015, 25, 129);
		rsinterface.child(14, 42016, 25, 149);
		rsinterface.child(15, 42017, 25, 169);
		rsinterface.child(16, 42018, 25, 189);
		rsinterface.child(17, 42019, 25, 209);
		rsinterface.child(18, 42020, 25, 229);
		rsinterface.child(19, 42021, 25, 249);
		rsinterface.child(20, 42022, 25, 269);
		rsinterface.child(21, 42023, 200, 91);
		rsinterface.child(22, 42024, 200, 111);
		rsinterface.child(23, 42025, 200, 131);
		rsinterface.child(24, 42026, 200, 151);
		rsinterface.child(25, 42027, 200, 171);
		rsinterface.child(26, 42028, 200, 191);
		rsinterface.child(27, 42029, 200, 211);
		rsinterface.child(28, 42030, 200, 231);
		rsinterface.child(29, 42031, 200, 251);
		rsinterface.child(30, 42032, 200, 271);
		rsinterface.child(31, 42033, 280, 91);
		rsinterface.child(32, 42034, 280, 111);
		rsinterface.child(33, 42035, 280, 131);
		rsinterface.child(34, 42036, 280, 151);
		rsinterface.child(35, 42037, 280, 171);
		rsinterface.child(36, 42038, 280, 191);
		rsinterface.child(37, 42039, 280, 211);
		rsinterface.child(38, 42040, 280, 231);
		rsinterface.child(39, 42041, 280, 251);
		rsinterface.child(40, 42042, 280, 271);
		rsinterface.child(41, 42043, 355, 91);
		rsinterface.child(42, 42044, 355, 111);
		rsinterface.child(43, 42045, 355, 131);
		rsinterface.child(44, 42046, 355, 151);
		rsinterface.child(45, 42047, 355, 171);
		rsinterface.child(46, 42048, 355, 191);
		rsinterface.child(47, 42049, 355, 211);
		rsinterface.child(48, 42050, 355, 231);
		rsinterface.child(49, 42051, 355, 251);
		rsinterface.child(50, 42052, 355, 271);
		rsinterface.child(51, 42053, 438, 91);
		rsinterface.child(52, 42054, 438, 111);
		rsinterface.child(53, 42055, 438, 131);
		rsinterface.child(54, 42056, 438, 151);
		rsinterface.child(55, 42057, 438, 171);
		rsinterface.child(56, 42058, 438, 191);
		rsinterface.child(57, 42059, 438, 211);
		rsinterface.child(58, 42060, 438, 231);
		rsinterface.child(59, 42061, 438, 251);
		rsinterface.child(60, 42062, 438, 271);
		rsinterface.child(61, 42063, 470, 32);
		rsinterface.child(62, 42064, 470, 32);
	}
	...
	public static void extraOptions(TextDrawingArea[] TDA) {
	        ...
	        addText(27504, "Unused:", 0xFF981F, true, true, -1, TDA, 1);
	        ...
	        addText(27519, "Unused:", 0xFF981F, true, true, -1, TDA, 1);
	...
	public static void preloadEquipmentWidget(TextDrawingArea[] tda) {
		...
		addText(32003, "OS-Brutality Preloaded Gear Management", tda, 2, 0xFF981F);
	...
	public static void starterInterface(TextDrawingArea[] TDA) {
		...
		addText(58503, "Normal", TDA, 3, 0xff9933, false, true);
		addText(58504, "Extreme", TDA, 3, 0xff9933, false, true);
		addText(58505, "Ironman", TDA, 3, 0xff9933, false, true);
		addText(58507, "1", TDA, 1, 0xffff00, true, true);
		addText(58508, "1", TDA, 1, 0xffff00, true, true);
		addText(58509, "1", TDA, 1, 0xffff00, true, true);
		addText(58510, "10", TDA, 1, 0xffff00, true, true);
		addText(58511, "1", TDA, 1, 0xffff00, true, true);
		addText(58512, "1", TDA, 1, 0xffff00, true, true);
		addText(58513, "1", TDA, 1, 0xffff00, true, true);
		addText(58514, "Welcome to OS-Brutality, we would recommend reading the tutorial\\nas it will help a lot. Enjoy your journey!", TDA, 0, 0xff9933, true, true);
		addText(58515, "In the normal game mode, you would get normal experience\\nfor skilling and high experience for combat, recommended\\nfor people who want to play and enjoy OS-Brutality casually.", TDA, 1, 0xff9933, true, true);
		addHoverButton(58516, "Starter/SPRITE", 1, 110, 31, "Confirm", -1, 58517, 1);
		addHoveredButton(58517, "Starter/SPRITE", 2, 110, 31, 58518);
		addText(58519, "Confirm", TDA, 3, 0xff9933, true, true);
		addConfigButton(58520, 58500, 3, 4, "Starter/SPRITE", 15, 15, "Select Normal", 0, 5, 1085);
		...
		addContainer(58523, 0, 9, 30, new String[] { null, null, null, null, null });
		...
		tab.child(5, 58507, 165, 255);
		tab.child(6, 58508, 215, 255);
		tab.child(7, 58509, 265, 255);
		tab.child(8, 58510, 315, 255);
		tab.child(9, 58511, 365, 255);
		tab.child(10, 58512, 415, 255);
		tab.child(11, 58513, 465, 255);
		tab.child(12, 58514, 310, 88);
		tab.child(13, 58515, 310, 130);
		tab.child(14, 58516, 23, 246);
		tab.child(15, 58517, 23, 246);
		tab.child(16, 58519, 75, 251);
		tab.child(17, 58520, 40, 93);
		tab.child(18, 58521, 40, 133);
		tab.child(19, 58522, 40, 173);
		tab.child(20, 58523, 139, 209);
	}
	...
	public static void questTab(TextDrawingArea[] TDA) {
		...
		addText(29155, "OS-Brutality", 0xFF981F, false, true, 52, TDA, 2);
		...
		addHoverText(29166, "", "View Progress", TDA, 0, 0xff0000,
				false, true, 150);
		addHoverText(663, "", "View Progress", TDA, 0, 0xff0000,
				false, true, 150);
		...
		setBounds(663, 4, 87, 6, Interface);
		int Ypos = 108;
		int frameID = 7;
