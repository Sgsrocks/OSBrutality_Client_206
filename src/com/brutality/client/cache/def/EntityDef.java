...
public final class EntityDef {
	...
	public static EntityDef forID(int i) {
		...
		if (i == 944) { // NPC ID
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Talk-to";
			entityDef.name = "OSBrutality Vote Shop"; // NPC name
		...
		if (i == 506) { // NPC ID
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Talk-to";
			entityDef.name = "OSBrutality Store"; // NPC name
			entityDef.description = "He sells the goods from the land of OSBrutality".getBytes(); // NPC
																								// description
		}
		if (i == 5809) { // NPC ID
			entityDef.actions = new String[5];
		...
		if (i == 5518) { // NPC ID
			...
			entityDef.name = "OSBrutality Child"; // NPC name
		...
		if (i == 3415) { // NPC ID
			...
			entityDef.description = "A Ranger from the OSBrutality Lands, selling his Ranging goods.".getBytes(); // NPC
																												// description
		}
		if (i == 5118) { // NPC ID
			entityDef.actions = new String[5];
		...
		if (i == 3833) { // NPC ID
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Talk-to";
			entityDef.name = "OSBrutality Angel"; // NPC name
